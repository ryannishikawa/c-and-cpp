...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      ///
      const auto carts = myStore.makeShoppingCarts();
    /////////////////////// END-TO-DO (2) ////////////////////////////
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      ///
      auto todaysSales = myStore.ringUpCustomers(carts);
    /////////////////////// END-TO-DO (3) ////////////////////////////
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      /// store's inventory.
      ///
      auto& inventory = myStore.inventory();
    ...
    ///////////////////////// TO-DO (5) //////////////////////////////
      ...
      myStore.reorderItems(todaysSales);
    /////////////////////// END-TO-DO (5) ////////////////////////////
  }
