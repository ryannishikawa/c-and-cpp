...
struct DLL
{
  ...
  {
    ///////////////////////// TO-DO (1) //////////////////////////////
    Node* newNodeRyanNishikawa = new Node(data);
    Node* currentNodeRyanNishikawa = position;

    newNodeRyanNishikawa->_next = currentNodeRyanNishikawa;
    newNodeRyanNishikawa->_prev = currentNodeRyanNishikawa->_prev;

    currentNodeRyanNishikawa->_prev->_next = newNodeRyanNishikawa;
    currentNodeRyanNishikawa->_prev = newNodeRyanNishikawa;

    ++_size;
    return newNodeRyanNishikawa;
    /////////////////////// END-TO-DO (1) ////////////////////////////
  }
