...
class GroceryItemDatabase
{
  ...
  private:
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      std::vector<GroceryItem> _dataStoreRN;

      GroceryItem * find(std::vector<GroceryItem>::iterator currentRN, std::vector<GroceryItem>::iterator endRN, const std::string & upcRN);
    /////////////////////// END-TO-DO (2) ////////////////////////////
};
